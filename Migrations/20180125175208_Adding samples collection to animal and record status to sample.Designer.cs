...
namespace SMS.Migrations
{
    ...
    [Migration("20180125175208_Adding samples collection to animal and record status to sample")]
    partial class Addingsamplescollectiontoanimalandrecordstatustosample
    {
